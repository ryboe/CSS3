...
func_name_to_completions = {
    ...
    "blenda": [("hsl",), ("hwb",), ("rgb",), t.percentage] + t.color,
    "blur": [t.length],
    "calc": [
        t.angle,
        t.frequency,
    ...
    "cielab": t.number,
    "cielchab": t.number,
    "color": [t.angle, t.number] + t.color,
    "color-adjuster-rgb": [t.hex_color, t.number, t.percentage],
    "conic-gradient": [
        ("at",),
        ("from",),
    ] + t.position + t.color_stop,
    "content": [
        ("after",),
        ("before",),
        ("first-letter",),
    ...
    "cross-fade": [t.percentage] + t.color + t.image,
    "cubic-bezier": [t.number],
    "device-cmyk": [t.number, t.percentage] + t.color,
    "device-gray": [t.number],
    "device-nchannel": [t.number],
    "device-rgb": [t.number],
    "dir": [("ltr",), ("rtl",)],
    "drop": [("active",), ("invalid",), ("valid",)],
    "drop-shadow": [t.length] + t.color,
    "element": [
        ("first",),
        ("first-except",),
        ("last",),
    ...
    "hsla": [t.angle, t.percentage, t.number],
    "hue-rotate": [t.angle],
    "hwb": [t.angle, t.number, t.percentage],
    "icc-color": [t.identifier, t.number] + t.icc_color,
    "image": [t.string] + t.image + t.color,
    "image-set": [t.resolution, t.string] + t.image,
