...
names = [
    ...
    ("-moz-column-span", "-moz-column-span: ${1};"),
    ...
    ("-webkit-column-count", "-webkit-column-count: ${1};"),
    ("-webkit-column-fill", "-webkit-column-fill: ${1};"),
    ("-webkit-column-gap", "-webkit-column-gap: ${1};"),
    ("-webkit-column-rule", "-webkit-column-rule: ${1};"),
    ("-webkit-column-rule-color", "-webkit-column-rule-color: ${1};"),
    ("-webkit-column-rule-style", "-webkit-column-rule-style: ${1};"),
    ("-webkit-column-rule-width", "-webkit-column-rule-width: ${1};"),
    ("-webkit-column-span", "-webkit-column-span: ${1};"),
    ("-webkit-column-width", "-webkit-column-width: ${1};"),
    ("-webkit-columns", "-webkit-columns: ${1};"),
    ("-webkit-font-kerning", "-webkit-font-kerning: ${1};"),
    ("-webkit-font-variant-ligatures", "-webkit-font-variant-ligatures: ${1};"),
    ("-webkit-hyphens", "-webkit-hyphens: ${1};"),
    ("-webkit-mask", "-webkit-mask: ${1};"),
    ("-webkit-mask-border", "-webkit-mask-border: ${1};"),
    ("-webkit-mask-border-mode", "-webkit-mask-border-mode: ${1};"),
    ("-webkit-mask-border-outset", "-webkit-mask-border-outset: ${1};"),
    ("-webkit-mask-border-repeat", "-webkit-mask-border-repeat: ${1};"),
    ("-webkit-mask-border-slice", "-webkit-mask-border-slice: ${1};"),
    ("-webkit-mask-border-source", "-webkit-mask-border-source: ${1};"),
    ("-webkit-mask-border-width", "-webkit-mask-border-width: ${1};"),
    ("-webkit-mask-clip", "-webkit-mask-clip: ${1};"),
    ("-webkit-mask-composite", "-webkit-mask-composite: ${1};"),
    ("-webkit-mask-image", "-webkit-mask-image: ${1};"),
    ("-webkit-mask-mode", "-webkit-mask-mode: ${1};"),
    ("-webkit-mask-origin", "-webkit-mask-origin: ${1};"),
    ("-webkit-mask-position", "-webkit-mask-position: ${1};"),
    ("-webkit-mask-repeat", "-webkit-mask-repeat: ${1};"),
    ("-webkit-mask-size", "-webkit-mask-size: ${1};"),
    ("-webkit-mask-type", "-webkit-mask-type: ${1};"),
    ("-webkit-perspective", "-webkit-perspective: ${1};"),
    ("-webkit-perspective-origin", "-webkit-perspective-origin: ${1};"),
    ("-webkit-text-emphasis", "-webkit-text-emphasis: ${1};"),
    ("-webkit-text-emphasis-color", "-webkit-text-emphasis-color: ${1};"),
    ("-webkit-text-emphasis-style", "-webkit-text-emphasis-style: ${1};"),
    ("-webkit-text-emphasis-width", "-webkit-text-emphasis-width: ${1};"),
...
name_to_completions = {
    ...
    "scroll-padding-block": t.length + t.percentage,
    "scroll-padding-block-end": t.length + t.percentage,
    "scroll-padding-block-start": t.length + t.percentage,
    "scroll-padding-bottom": t.length + t.percentage,
    "scroll-padding-inline": t.length + t.percentage,
    "scroll-padding-inline-end": t.length + t.percentage,
    "scroll-padding-inline-start": t.length + t.percentage,
    "scroll-padding-left": t.length + t.percentage,
    "scroll-padding-right": t.length + t.percentage,
    "scroll-padding-top": t.length + t.percentage,
    "scroll-snap-align": [("center",), ("end",), ("none",), ("start",)],
    "scroll-snap-margin": t.length,
    "scroll-snap-margin-block": t.length,
    "scroll-snap-margin-block-end": t.length,
    "scroll-snap-margin-block-start": t.length,
    "scroll-snap-margin-bottom": t.length,
    "scroll-snap-margin-inline": t.length,
    "scroll-snap-margin-inline-end": t.length,
    "scroll-snap-margin-inline-start": t.length,
    "scroll-snap-margin-left": t.length,
    "scroll-snap-margin-right": t.length,
    "scroll-snap-margin-top": t.length,
